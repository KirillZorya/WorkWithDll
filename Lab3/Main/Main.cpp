...
int main(int argc, char* argv[])
{
    ...
    // Loading library
    HINSTANCE DllInstance = LoadLibrary(L"Lab3.dll");
    ...
    char decrypted[32];
    time_t start, end;
    unsigned long long n = 5612626;
    unsigned long e = 6;
    unsigned long long d = 8939820;
   ...
   std::cout << "\n\n\n" << " -------- Second Part -------- " << "\n\n\n";
    ...
    if (argv[1][0] == '1') {
        std::cout << "Done! English selected" << std::endl;
        ...
        std::cout << "Готово! Обрано українську" << std::endl;
